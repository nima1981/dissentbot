...
/*	  filter: {
    ...
    const messages = [
      ...
      { role: 'system', content: 'What follows is a set of paragraphs representing online posts that are relevant to this conversation, also known as Context. They are ordered by relevance from more to less relevant. Each Context paragraph consists of Title, Author, Content, Date, Primary URL, and optionally NOSTR URL. When formulating your answer you must incorporate Title, Author, Content, Primary URL (and the NOSTR URL if and only if provided) from every single paragraph from the following Context: \n\n' + context },
