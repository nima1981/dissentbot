...
export default async function handler(req, res) {
  ...
  try {
    ...
    const messages = [
      { role: 'system', content: process.env.INSTRUCTIONS + " Today's date and time is " + today + ". Use this date as a reference point for any predictions, analyses, or interpretations of events when formulating your response. If the user asks you to generate an image but you're unable to, please disregard all context and simply advise them to select 'Image' instead of 'Text' in the 'Type' dropdown of this app." },
